...
-- 默认账号（密码统一为 123456，BCrypt加密后的值）
-- 实际密文请用 BCryptPasswordEncoder 生成后替换
INSERT INTO sys_user(username, password, real_name, role, college_id) VALUES
('admin',     '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '校级管理员', 5, NULL),
('jiaowu',    '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '教务处审核员', 4, NULL),
('cs_audit',  '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '计信院审核员', 3, 1),
('student01', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '张三', 1, 1),
('alumni01',  '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '李四', 2, 1);
...
-- ⚠️ 默认密码 BCrypt 密文需自行用 BCryptPasswordEncoder.encode("123456") 生成后替换上方占位密文。